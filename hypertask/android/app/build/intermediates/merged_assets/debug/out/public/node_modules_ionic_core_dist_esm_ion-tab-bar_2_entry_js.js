...
const TabBar = class {
  ...
  render() {
    ...
    return ((0,_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_0__.H, { role: "tablist", "aria-hidden": keyboardVisible ? 'true' : null, class: (0,_theme_a24ff1ad_js__WEBPACK_IMPORTED_MODULE_2__.c)(color, {
        [mode]: true,
...
const TabButton = class {
  ...
  componentWillLoad() {
    if (this.layout === undefined) {
      this.layout = _ionic_global_0ebe321c_js__WEBPACK_IMPORTED_MODULE_1__.c.get('tabButtonLayout', 'icon-top');
    }
  }
  selectTab(ev) {
