...
// import { ILogger } from '../interfaces/i-logger'; TODO CAPACITOR
...
//       const scheduled = await this.localNotifications.getAll();
...
//             DateUtils.datesAreEqual(new Date(notif.trigger.at), todayWorkDate)) {
//           await this.localNotifications.cancel(notif.id);
...
//             const notification = await this.localNotifications.get(task.NotificationId);
//             /*try {
